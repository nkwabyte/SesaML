...
# predictions under outputs/asr/runs/<run_id>/.
#
# Usage:
#   scripts/asr/evaluate.sh
#   scripts/asr/evaluate.sh --model-path outputs/asr/checkpoints/train-20260809-120000/best_model.pt
#   scripts/asr/evaluate.sh --csv-path data/corpus/verified_data.csv
#
